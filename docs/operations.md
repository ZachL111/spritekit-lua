...
`spritekit-lua` is centered on game engines work in Lua. The technical target is: Drive tile animation timelines, sprite sheets, and collision masks.
...
The score is deterministic. The current threshold is 150. Risk has a penalty of 6, latency has a penalty of 2, and weight contributes a bonus of 4.
