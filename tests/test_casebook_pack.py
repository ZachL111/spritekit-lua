"""Regression checks for the spritekit-lua casebook."""
...
from casebook.harness import assert_expected, spritekit_lua_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(spritekit_lua_summary(), assert_expected())
