...
spritekit-lua is a Lua project for game engines. It focuses on this technical goal: Drive tile animation timelines, sprite sheets, and collision masks.
...
The core module exposes a small scoring API. Inputs are simple numeric signals: demand, capacity, latency, risk, and weight. The score uses a threshold of 150, risk penalty 6, latency penalty 2, and weight bonus 4. Tests exercise the public API against the fixture cases in `fixtures/cases.csv`.
